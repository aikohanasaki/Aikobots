...
function sendAssistantMessage() {
    ...
    const message = {
        name: name,
        force_avatar: avatar,
        mes: t`# ⚠️ __**v1 Shutting Down**__ ⚠️` + '\n\n' + t`This is v1 of Aikobots, and it is scheduled to be **shutdown and retired** soon after May 1, 2026.`  + '\n\n' + t`v2 of Aikobots was launched in April 2026 and is where bots, updates, pushes etc are going forward. Please contact Aiko to get on v2. Yes, Aiko can keep your username and your old chats and transfer them from v1 to v2 with no issues.`  + '\n\n' + t`If you don't want to move to v2, please make sure to export all your chats before shutdown.`,
        is_system: false,
        is_user: false,
