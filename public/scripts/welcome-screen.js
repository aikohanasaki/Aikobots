...
async function getRecentChats() {
    ...
    dataWithEntities.forEach(({ chat, character, group }, index) => {
        ...
        chat.chat_name = String(chat.file_name || '').replace(/\.(jsonl|sqlite)$/i, '');
